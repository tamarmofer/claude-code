...
| [claude-model-migration](./claude-model-migration/) | Migrate code and prompts to the current Claude generation (Claude Opus 4.8) | **Skill:** `claude-model-migration` - Automated migration of model strings, removed parameters, beta headers, and prompt adjustments |
